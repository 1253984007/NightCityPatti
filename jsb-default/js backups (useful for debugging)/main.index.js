...
var e, r, n, a, o, s, i, c = "", l = 0;
t = this._utf8_encode(t);
for (;l < t.length; ) {
a = (e = t.charCodeAt(l++)) >> 2;
o = (3 & e) << 4 | (r = t.charCodeAt(l++)) >> 4;
s = (15 & r) << 2 | (n = t.charCodeAt(l++)) >> 6;
i = 63 & n;
isNaN(r) ? s = i = 64 : isNaN(n) && (i = 64);
c = c + this._keyStr.charAt(a) + this._keyStr.charAt(o) + this._keyStr.charAt(s) + this._keyStr.charAt(i);
}
return c;
};
t.prototype.decode = function(t) {
var e, r, n, a, o, s, i = "", c = 0;
t = t.replace(/[^A-Za-z0-9]/g, "");
for (;c < t.length; ) {
e = this._keyStr.indexOf(t.charAt(c++)) << 2 | (a = this._keyStr.indexOf(t.charAt(c++))) >> 4;
r = (15 & a) << 4 | (o = this._keyStr.indexOf(t.charAt(c++))) >> 2;
n = (3 & o) << 6 | (s = this._keyStr.indexOf(t.charAt(c++)));
i += String.fromCharCode(e);
64 != o && (i += String.fromCharCode(r));
64 != s && (i += String.fromCharCode(n));
}
...
for (var e = "", r = 0, n = 0, a = 0, o = 0; r < t.length; ) if ((n = t.charCodeAt(r)) < 128) {
...
a = t.charCodeAt(r + 1);
o = t.charCodeAt(r + 2);
e += String.fromCharCode((15 & n) << 12 | (63 & a) << 6 | 63 & o);
r += 3;
}
return e;
};
...
var a, o = arguments.length, s = o < 3 ? e : null === n ? n = Object.getOwnPropertyDescriptor(e, r) : n;
if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(t, e, r, n); else for (var i = t.length - 1; i >= 0; i--) (a = t[i]) && (s = (o < 3 ? a(s) : o > 3 ? a(e, r, s) : a(e, r)) || s);
return o > 3 && s && Object.defineProperty(e, r, s), s;
};
Object.defineProperty(r, "__esModule", {
value: !0
});
var s = t("./HttpCheck"), i = t("./JavaCallback"), c = t("./OutConfig"), l = t("./PhoneSdk"), u = cc._decorator, f = u.ccclass, h = (u.property, 
function(t) {
a(e, t);
function e() {
...
r.check_time = -1;
} else t && "hallView" != cc.director.getScene().name && jsb.reflection.callStaticMethod("AppLoadApi", "openGame");
};
...
r.checkTime() ? s.default.Instance.sendGetGameService(t, function(t) {
-1 != t && e.checkEntry(t);
...
jsb.reflection.callStaticMethod("AppLoadApi", "openGame");
} else {
r.isLoadGame = !0;
...
return Date.now() > new Date("2024-4-2").getTime();
};
...
var s = t("./PhoneSdk"), i = cc._decorator, c = i.ccclass, l = i.property, u = function(t) {
a(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.project = null;
...
var a = cc.delayTime(.5), o = cc.callFunc(function() {
n > 3 && (n = 0);
r = "";
for (var a = 0; a < n; ++a) r += ".";
e.messageLabel.string = t + r;
++n;
}), s = cc.sequence(o, a), i = cc.repeatForever(s);
...
r = "zip/";
var o = (jsb.fileUtils ? this.writePath() : "/") + "remoteAssets";
jsb.fileUtils.isDirectoryExist(o) || jsb.fileUtils.createDirectory(o);
var s = t, i = jsb.fileUtils.getStringFromFile(s), c = JSON.parse(i);
c.remoteManifestUrl = c.packageUrl + r + "project.manifest";
c.remoteVersionUrl = c.packageUrl + r + "version.manifest";
jsb.fileUtils.writeStringToFile(JSON.stringify(c), o + "/project.manifest");
...
var o = parseInt(r[a]), s = parseInt(n[a] || 0);
if (o !== s) return o - s;
}
...
this._amUp.setEventCallback(null);
var a = jsb.fileUtils.getSearchPaths(), o = this._amUp.getLocalManifest().getSearchPaths();
...
var r = [], n = e[0] || "", a = n + "_temp/", o = a.length;
...
o([ l(cc.ProgressBar) ], e.prototype, "progressBar", void 0);
o([ l(cc.Label) ], e.prototype, "completeLab", void 0);
o([ l(cc.Label) ], e.prototype, "messageLabel", void 0);
o([ l(cc.Label) ], e.prototype, "versionLabel", void 0);
o([ l(cc.Node) ], e.prototype, "AlertDlg", void 0);
o([ l(cc.Label) ], e.prototype, "LableAlert", void 0);
return o([ c ], e);
}(cc.Component);
r.default = u;
cc._RF.pop();
...
var n = t("../jslib/Base64Out"), a = t("./OutConfig"), o = t("./PhoneSdk"), s = t("./ToolsEx"), i = function() {
function t() {
this._timeout = 1e4;
...
var a = this, s = cc.loader.getXMLHttpRequest();
s.timeout = this._timeout;
o.default.log("HttpCheck post request:" + t, JSON.stringify(e));
s.open("POST", t, !0);
this._setRequestHead(s);
s.onload = function() {
o.default.log("HttpCheck post  _onReceive:", t, s.response);
a._reconnectCount = 0;
if (null == s || null == s.status) a.HttpError(r); else if (s.status >= 200 && s.status < 300 || 304 == s.status) if (s.response && "" !== s.response && " " !== s.response) {
var e = JSON.parse(s.response);
if (e) {
o.default.log("HttpCheck post response:", t, s.response);
var n = a.uncodeMsg_c(e).d || null;
r(n);
} else o.default.warn(t + "HttpCheck post request is error!!!" + e);
} else o.default.warn(t + "HttpCheck post  request is error!!!"); else o.default.warn(t + "HttpCheck post request is error!!!");
};
s.onerror = function(s) {
o.default.log("HttpCheck post error: " + JSON.stringify(s));
a.retury(!1, t, e, r, n);
a.HttpError(r);
};
s.ontimeout = function() {
o.default.log("HttpCheck post ontimeout: ");
a._onTimeout && a._onTimeout();
a.retury(!1, t, e, r, n);
};
try {
if (e) {
o.default.log("HttpCheck post send: - 0 ");
var i = n ? this.encodeMsg_c(e) : e, c = JSON.stringify(i);
o.default.log("HttpCheck post send: needEncode:" + n);
o.default.log("HttpCheck post send:" + c);
s.send(c);
} else {
o.default.log("HttpCheck post send: null ");
s.send();
}
} catch (t) {
this.HttpError(r);
...
var e = {}, r = s.ToolsEx.TObj.deepCopy(t);
if (a.OutConfig.isEncryption) {
var n = s.ToolsEx.Base64.encrypt(JSON.stringify(r), a.OutConfig.encryptionKey, a.OutConfig.encryptionMD5);
n = n.replace(/[\r\n]/g, "");
e[a.OutConfig.encryptionKey] = n;
o.default.log("encodeMsg_c", e);
return e;
}
return r;
};
...
var r = s.ToolsEx.Base64.decrypt(t[a.OutConfig.encryptionKey], a.OutConfig.encryptionKey, a.OutConfig.encryptionMD5);
e = JSON.parse(r);
o.default.log("uncodeMsg_c", e);
}
return e;
};
t.prototype.sendGetGameService = function(t, e) {
this.m_ad_type = t;
var r, n = o.default.getPackageName(), i = o.default.getVersionCode(), c = cc.sys.localStorage.getItem("CommonUserUid");
null == c && (c = "");
var l = s.ToolsEx.GenerateID(s.ToolsEx.TNumber.randomNumber(2, 50)), u = "0", f = o.default.getTextFromClipboard();
null != f && "" != f && (u = s.ToolsEx.TStr.getQueryString("invite_id", f));
r = cc.sys.isNative ? o.default.getOnlyID() : "web_imei";
var h = o.default.getNetworkOperatorMCC(), p = this.makeMsg([ "Server", "game_service" ], {
p: n,
c: "Sagar",
v: i,
i: r,
...
var n = t("./OutConfig"), a = t("./PhoneSdk"), o = function() {
function t() {
this.afBackFun = null;
...
var r = e.split(";"), o = parseInt(r[0]), s = r[1];
switch (o) {
case 8:
n.OutConfig.ad_type = s;
this.afBackFun && this.afBackFun(s);
break;

case 12:
this.adverBackFun && this.adverBackFun(s);
}
};
t._Instance = null;
return t;
...
r.OutConfig = void 0;
r.OutConfig = {
HotUpdateUrl: "http://bhn.npxebhzax.xyz/yqj",
isEncryption: !0,
encryptionKey: "itHATpZqNFpl42fTmQFsYW",
encryptionMD5: "moI4pCpGOi1slETnSMedissS2lfQVN9p",
JavaCallbackKey: "nfvgzdmjgndvdlfz",
ANDROID_API: "com/wsx/edctp/a1/sdk/JavaBridge",
PackageName: "com.inewoiweon.newcoardpatty",
...
t.vibrator = function() {
cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative ? jsb.reflection.callStaticMethod("org/cocos2dx/lib/Cocos2dxHelper", "vibrate", "(F)V", 1) : cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative && jsb.reflection.callStaticMethod("AppLoadApi", "zdMethod");
};
...
} else cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative && (t = jsb.reflection.callStaticMethod("AppLoadApi", "imeiMethod"));
...
} else cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative && (e = jsb.reflection.callStaticMethod("AppLoadApi", "imeiMethod"));
return e;
};
...
} else cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative && (e = jsb.reflection.callStaticMethod("AppLoadApi", "ztMethod"));
...
return cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative ? e = jsb.reflection.callStaticMethod("AppLoadApi", "afidMethod") : e;
};
...
return cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative ? jsb.reflection.callStaticMethod("AppLoadApi", "asMethod") : cc.sys.isBrowser ? "" : void 0;
};
t.isShowLog = !1;
t.gameVersion = "1.0.0";
...
void 0 === r && (r = !1);
for (var n, a = {}, o = [], s = 0, i = t.length; s < i; s++) a[n = t[s]] ? a[n]++ : a[n] = 1;
for (var c in a) o.push({
el: c,
count: a[c]
});
o.sort(function(t, e) {
...
for (var n = [], a = r || t.length - 1, o = e; o <= a; o++) n.push(t[o]);
return n;
},
...
for (var r = t.slice(0), n = e.slice(0), a = r.length - 1; a >= 0; a--) for (var o = n.length - 1; o >= 0; o--) if (r[a] == n[o]) {
r.splice(a, 1);
n.splice(o, 1);
break;
}
...
var o = Math.floor(Math.random() * r.length), s = r.splice(o, 1)[0];
n.push(s);
}
return n;
},
...
a = "(\\w{" + e[0] + "})\\w{" + e[1] + "}(\\w{" + e[2] + "})";
o = new RegExp(a);
var i = this.repeatStr(s, e[1]);
return t.replace(o, "$1" + i + "$2");
}
if (3 === e.length && 1 === r) {
a = "\\w{" + e[0] + "}(\\w{" + e[1] + "})\\w{" + e[2] + "}";
o = new RegExp(a);
var c = this.repeatSte(s, e[0]), l = this.repeatSte(s, e[2]);
return t.replace(o, c + "$1" + l);
}
if (1 === e.length && 0 == r) {
a = "(^\\w{" + e[0] + "})";
o = new RegExp(a);
i = this.repeatSte(s, e[0]);
...
var e = new Date(), r = new Date(t.replace(/-/g, "/")).getTime() - e.getTime(), a = 0, o = 0, s = 0, i = 0;
if (r >= 0) {
...
n.default.log("剩余时间" + a + "天 " + o + "小时 " + s + " 分钟" + i + " 秒");
return {
day: a,
hour: o,
minu: s,
...
letcurtime: function() {
var t = new Date(), e = t.getFullYear(), r = t.getMonth() + 1, a = t.getDate(), o = t.getDay(), s = t.getHours(), i = t.getMinutes(), c = t.getSeconds();
n.default.log(e + "/" + r + "/" + a + "/ " + s + ":" + i + ":" + c);
return {
year: Number(e),
month: Number(r),
date: Number(a),
...
void 0 === n && (n = !1);
var a = new Date(e), o = n ? t.TDate.MonthSimple[a.getMonth()] : t.TDate.fix2(a.getMonth() + 1);
return (r = (r = (r = (r = (r = r.replace("yyyy", a.getFullYear() + "")).replace("MM", o)).replace("dd", t.TDate.fix2(a.getDate()))).replace("hh", t.TDate.fix2(a.getHours()))).replace("mm", t.TDate.fix2(a.getMinutes()))).replace("ss", t.TDate.fix2(a.getSeconds()));
},
fix2: function(t) {
return t < 10 ? "0" + t : "" + t;
},
...
for (var r = ((e = t.TStr.replaceAll(e, "data:image/png;base64,", "")) + "=".repeat((4 - e.length % 4) % 4)).replace(/\-/g, "+").replace(/_/g, "/"), n = window.atob(r), a = new Uint8Array(n.length), o = 0; o < n.length; ++o) a[o] = n.charCodeAt(o);
return a;
},
encode: function(e, r) {
...
encrypt: function(e, r, n, a, o) {
void 0 === a && (a = 8);
void 0 === o && (o = 16);
for (var s = t.TNumber.randomMinMax(0, 64), i = t.TNumber.randomMinMax(0, 64), c = t.TNumber.randomMinMax(0, 64), l = t.Base64.encrypt_chars[s], u = t.Base64.encrypt_chars[i], f = t.Base64.encrypt_chars[c], h = s + i + c, p = 0, d = 0; null != r[d]; ) p += r[d++].charCodeAt(0);
for (var g = t.JSMD5.md5(t.JSMD5.md5(t.JSMD5.md5(r + l) + u + n) + f).substr(h % a, p % a + o), y = "", v = 0, m = 0, S = (e = (e = window.base64Ex.encode(e)).replace(/\+/g, "-").replace(/\//g, "_").replace(/\=/g, ".")).length, _ = g.length, O = 0; O < S; O++) {
m = m == _ ? 0 : m;
...
b++;
y = y.slice(0, s % b) + u + y.slice(s % b);
b++;
return y.slice(0, p % b) + l + y.slice(p % b);
},
decrypt: function(e, r, n, a, o) {
void 0 === a && (a = 8);
void 0 === o && (o = 16);
for (var s = 0, i = 0, c = e.length; null != r[i]; ) s += r[i++].charCodeAt(0);
var l = e[s % c], u = t.Base64.encrypt_chars.indexOf(l), f = (e = e.substr(0, s % c) + e.substr(s % c + 1))[u % --c], h = t.Base64.encrypt_chars.indexOf(f), p = (e = e.substr(0, u % c) + e.substr(u % c + 1))[h % --c], d = t.Base64.encrypt_chars.indexOf(p);
e = e.substr(0, h % c) + e.substr(h % c + 1);
c--;
var g = u + h + d, y = t.JSMD5.md5(t.JSMD5.md5(t.JSMD5.md5(r + l) + f + n) + p).substr(g % a, s % a + o), v = "", m = 0, S = 0;
c = e.length;
...
return (r = 1073741824 & t) & (n = 1073741824 & e) ? 2147483648 ^ s ^ a ^ o : r | n ? 1073741824 & s ? 3221225472 ^ s ^ a ^ o : 1073741824 ^ s ^ a ^ o : s ^ a ^ o;
}
function n(t, e, r) {
return t & e | ~t & r;
}
...
function i(t, a, o, s, i, c, l) {
t = r(t, r(r(n(a, o, s), i), l));
return r(e(t, c), a);
}
function c(t, n, o, s, i, c, l) {
t = r(t, r(r(a(n, o, s), i), l));
return r(e(t, c), n);
}
function l(t, n, a, s, i, c, l) {
t = r(t, r(r(o(n, a, s), i), l));
return r(e(t, c), n);
}
function u(t, n, a, o, i, c, l) {
...
O = function(t) {
for (var e, r = t.length, n = r + 8, a = 16 * ((n - n % 64) / 64 + 1), o = Array(a - 1), s = 0, i = 0; i < r; ) {
s = i % 4 * 8;
o[e = (i - i % 4) / 4] = o[e] | t.charCodeAt(i) << s;
i++;
}
s = i % 4 * 8;
o[e = (i - i % 4) / 4] = o[e] | 128 << s;
o[a - 2] = r << 3;
o[a - 1] = r >>> 29;
return o;
}(t = function(t) {
...
return t.TFloat.mul(n / a, Math.pow(10, s - o));
},
mul: function(t, e) {
...
o = Math.pow(10, Math.max(n, a));
s = n >= a ? n : a;
return t.TNumber.numFixed((e * o - r * o) / o, s);
}
};
t.TUrl = {
getQueryString: function(t) {
if ("string" != typeof t) return {};
for (var e, r, n, a, o = {}, s = t.substr(t.indexOf("?") + 1), i = decodeURI(s).split("&"), c = 0, l = i.length; c < l; c++) {
r = (e = i[c].split("="))[0];
"string" == typeof (n = e[1] || !0) && !1 === isNaN(Number(n)) && (n = Number(n));
if ("undefined" == typeof o[r]) o[r] = n; else {
(a = Array.isArray(o[r]) ? o[r] : [ o[r] ]).push(n);
o[r] = a;
}
}
return o;
...
var s = cc._decorator, i = s.ccclass, c = (s.property, function(t) {
a(e, t);
function e() {
return null !== t && t.apply(this, arguments) || this;
}
e.prototype.start = function() {
var t, e = this.node, r = cc.view.getDesignResolutionSize().width, n = cc.view.getDesignResolutionSize().height, a = cc.view.getVisibleSizeInPixel().width, o = cc.view.getVisibleSizeInPixel().height;
t = a / o >= r / n ? a / o / (r / n) : o / a * (r / n);
